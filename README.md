...
Latest data is from **4<sup>th</sup> March 2020**.
...
* On the left is the spherical weighted average of latitiude and longitude (where smallest area is recorded as e.g. Chinese province) of confirmed cases. As the majority of cases are still in Hubei, China, the "centre of mass" of the outbreak is still very much in China, having moved only ~3.5° west.
